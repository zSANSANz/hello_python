...
def tanya(step):
    pertanyaan = {
        1: "Antum mau daftar sebagai: (1) DAUROH ASTATIDZAH INDONESIA(DAI) / (2) DAUROH IMAM SYAFII(DIS)",
        2: "Nama lengkap antum?",
        3: "Asal daerah/pondok?",
        4: "Nomor WA?",
        5: "Transportasi kedatangan?",
        6: "Tuliskan Ketua Rombongan jika datang dalam rombongan",
        7: "Tanggal & Jam Kedatangan?",
        8: "Transportasi kepulangan?",
        9: "Lokasi pengantaran?",
        10: "Tanggal & Jam Kepulangan?",
        11: "Datang sendiri/rombongan?",
        12: "Nama Ustadz Pendamping / PIC?",
    }
